...
import com.charaminstra.pleon.common.model.KaKaoRequestBody
import com.charaminstra.pleon.common.model.LoginResponse
import com.charaminstra.pleon.common.model.SmsResponse
...
class AuthRepository @Inject constructor(private val service: AuthAPIService, private val prefs: PleonPreference)  {
    ...
    suspend fun postPhoneNum(phone: String) = service.postPhone(
        com.charaminstra.pleon.common.model.SmsRequestBody(
            phone
        )
    )

    suspend fun postCode(phone: String, code:String): Response<SmsResponse> {
        val model = com.charaminstra.pleon.common.model.SmsCodeRequestBody(phone, code)
