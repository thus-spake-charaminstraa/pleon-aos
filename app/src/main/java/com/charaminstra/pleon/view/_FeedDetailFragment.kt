...
import com.charaminstra.pleon.adapter._CommentsAdapter
import com.charaminstra.pleon.databinding.FragmentFeedDetailBinding
import com.charaminstra.pleon.viewmodel._FeedDetailViewModel
import dagger.hilt.android.AndroidEntryPoint
import java.text.SimpleDateFormat

@AndroidEntryPoint
class _FeedDetailFragment : Fragment() {

    private val viewModel: _FeedDetailViewModel by viewModels()
    //private lateinit var feedId : String
    private lateinit var binding : FragmentFeedDetailBinding
    private lateinit var navController: NavController
    private lateinit var dateFormat: SimpleDateFormat
    private lateinit var commentsAdapter: _CommentsAdapter
